...
public class StreamExecutionEnvironment {
     ...
     * SingleOutputStreamOperator#setParallelism(int)})
     ...
     *     contains {@link NumberSequenceSource}.
     */
    @Deprecated
     ...
     * type class (as given in {@link #fromCollection(Iterator, Class)} does not supply
     ...
     * #fromParallelCollection(SplittableIterator, Class)} does not supply all
     * type information.
     *
     * @param iterator The iterator that produces the elements of the data stream
     * @param typeInfo The TypeInformation for the produced data stream.
     ...
     * ResultTypeQueryable} interface. In the latter case, this
     * method will invoke the {@link
     * ResultTypeQueryable#getProducedType()} method to
     ...
     * implement the {@link ResultTypeQueryable} interface.
     *
     * <p><b>NOTES ON CHECKPOINTING: </b> In the case of a {@link FileInputFormat}, the source
     * (which executes the {@link ContinuousFileMonitoringFunction}) monitors the path, creates the
     * {@link org.apache.flink.core.fs.FileInputSplit FileInputSplits} to be processed, forwards
     ...
     * ParallelSourceFunction} or extend {@link
    ...
    /**
     * Getter of the {@link StreamGraph StreamGraph} of the
     ...
     * not disabled in the {@link ExecutionConfig}
     */
    @Internal
     ...
     * provides access {@link DistributedCache} via {@link
